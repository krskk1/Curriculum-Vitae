...
|言語|レベルなど|
|-----|-----|
|Kotlin|5年以上の開発経験。2017年に Android の開発言語に正式される前から。設計から実装まで経験あり。最近最も使用しており自身のある言語|
...
### 2020/02 〜 現在：A社（業務委託のち正社員）
#### ライブコマースアプリの開発
- Android アプリ開発の主担当（他に Android エンジニアはいない）
- 最初の3ヶ月は業務委託として就業。その後正社員となる
- Android Architecture Components がほぼ導入されていなかったのをリファクタ（まだ途中）

### 2019/12 〜 2020/01 ：B社（業務委託）
#### 新規女性向けマンガアプリの開発
- Android アプリ開発メンバー（他に2名）
- 業務委託で2ヶ月のみ就業
- UI部分や、Cloud FireStore部分を担当

### 2019/8 〜 2019/11 :C社（正社員）
#### マッチングアプリ開発
- Android、iOS アプリエンジニア
- 新規機能開発、不具合対応などを担当
- 若いメンバーが多く育成しながらの開発が非常に楽しかった

### 2019/7 〜 2019/8 :D社（副業、業務委託）
#### キッチンカーアプリ開発
- Android アプリエンジニア
- UI や QRコード決済を担当

### 2016/6 〜 2019/8 :E社（業務委託のち正社員）
#### クレジットカード履歴管理アプリ
